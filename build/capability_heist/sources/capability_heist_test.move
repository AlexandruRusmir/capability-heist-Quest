module overmind::capability_heist_test {
    ...
    fun test_take_hostage() {
        ...
        let enterBank = capability_heist::new_enter_bank();
        capability_heist::delegate_capability(&robber, &enterBank);
    ...
    fun test_get_keycard() {
        ...
        let enterBank = capability_heist::new_enter_bank();
        capability_heist::delegate_capability(&robber, &enterBank);
        let takeHostage = capability_heist::new_take_hostage();
        capability_heist::delegate_capability(&robber, &takeHostage);
    ...
    fun test_open_vault() {
        ...
        let takeHostage = capability_heist::new_take_hostage();
        capability_heist::delegate_capability(&robber, &takeHostage);
        let getKeyCard = capability_heist::new_get_keycard();
        capability_heist::delegate_capability(&robber, &getKeyCard);
